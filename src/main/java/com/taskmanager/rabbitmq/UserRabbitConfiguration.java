...
public class UserRabbitConfiguration {
    ...
    public static final String ROUTING_KEY_CREATE = "user.created";

    // UPDATE
    public static final String QUEUE_UPDATE = "user.updated.queue";
    public static final String ROUTING_KEY_UPDATE = "user.updated";

    // DELETE
    public static final String QUEUE_DELETE = "user.deleted.queue";
    public static final String ROUTING_KEY_DELETE = "user.deleted";
